...
## Список функций
### Кратко
|Платформа|Достижения|Списки лидеров|Облачное сохранение|Реклама|Покупки|Получить время|
|---|---|---|---|---|---|---|
|GameJolt|✅|✅|✅|||✅|
|Steam|✅|✅|Автоматически|||Через Game Jolt API|
|VK Play|✅||Автоматически|||Через Game Jolt API|
|itch.io||||||Через Game Jolt API|
|Google Play|✅|✅|✅|Яндекс Реклама|Невозможно протестировать|Через Game Jolt API|
|RuStore|||||Нет готового решения|Через Game Jolt API|
|Yandex Games||Только отправка||✅||✅|
|VK Games||||✅|||
|Newgrounds|✅|✅|✅|||✅|
### Подробно
|Функция|Game Jolt|Steam|Epic Games|VK Play|itch.io|Google Play|RuStore|Yandex Games|VK Games|Newgrounds|
|---|---|---|---|---|---|---|---|---|---|---|
|Инициализация|Не требуется|Автоматически||Автоматически||Не требуется|Не требуется|✅|✅|✅|
|Вход|✅|Не требуется||Не требуется||✅|Не требуется||Не требуется|Автоматически|
|Выход|✅|||||✅|||||
|Получить данные пользователя|✅|✅|||||||||
|Показать достижения|✅|✅||||✅|||||
|Прочитать достижения|✅|✅||✅||✅|||||
|Получить достижение|✅|✅||✅||✅||||✅|
|Удалить достижение|✅|✅||✅||Вручную разработчиком||||Вручную пользователем|
|Удалить все достижения|Сделано циклом|✅||✅||Вручную разработчиком||||Вручную пользователем|
|Показать рекорды|✅|||||✅|||||
|Отправить рекорд|✅|✅||||✅||✅||✅|
|Получить рекорды|✅|✅||||✅||||✅|
|Прочитать данные|Сделано через восст.|Автоматически||Автоматически||✅||||✅|
|Сохранить в облако|✅|Автоматически||Автоматически||✅||||✅|
|Восстановить из облака|✅|Вручную пользователем||Вручную пользователем||✅||||✅|
|Удалить из облака|✅|||||✅|||||
|Получить время|✅|Через Game Jolt|Через Game Jolt|Через Game Jolt|Через Game Jolt|Через Game Jolt|Через Game Jolt|✅||YYYY-MM-DDTHH:MM:SS-05:00|
|Показать баннер||||||Яндекс Реклама|Яндекс Реклама|✅|✅||
|Убрать баннер||||||Яндекс Реклама|Яндекс Реклама|✅|✅||
|Загрузить межстраничную||||||Яндекс Реклама|Яндекс Реклама|✅|✅||
|Показать межстраничную||||||Яндекс Реклама|Яндекс Реклама|✅|✅||
|Загрузить видео||||||Яндекс Реклама|Яндекс Реклама|✅|✅||
|Показать видео||||||Яндекс Реклама|Яндекс Реклама|✅|✅||
